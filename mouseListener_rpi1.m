function mouseListener_rpi1(varargin)
...
rigSpecific;
RPihost = 'mps-rpi2.cin.ucsf.edu'; %must be set to REAL Rpi name or IP address
RPiport = 8932;
psychstimhost = 'mps-pc49.cin.ucsf.edu'; % runs PsychStimController
